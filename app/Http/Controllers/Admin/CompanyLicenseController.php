...
class CompanyLicenseController extends Controller
{
    public function index()
    {
        ...
        return view('admin.company-license.index', compact('companyLicenses'));
    }

    public function create()
    {
        return view('admin.company-license.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.company-license.index')->with('success', 'Data perusahaan berhasil ditambahkan.');
    }

    public function show(CompanyLicense $companyLicense)
    {
        return view('admin.company-license.show', compact('companyLicense'));
    }

    public function edit(CompanyLicense $companyLicense)
    {
        return view('admin.company-license.edit', compact('companyLicense'));
    }
    ...
    public function update(Request $request, CompanyLicense $companyLicense)
    {
        ...
        return redirect()->route('admin.company-license.index')->with('success', 'Data perusahaan berhasil diperbarui.');
    }
    ...
    public function destroy(CompanyLicense $companyLicense)
    {
        ...
        return redirect()->route('admin.company-license.index')->with('success', 'Data perusahaan berhasil dihapus.');
    }
}
