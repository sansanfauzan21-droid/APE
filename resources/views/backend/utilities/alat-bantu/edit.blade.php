        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Data Alat Bantu</h5>
                    <a href="{{ route('alat-bantu.index') }}" class="btn btn-secondary">
                        <i class="bx bx-arrow-back me-1"></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('alat-bantu.update', $alatBantu) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_peralatan_software') is-invalid @enderror"
                                       id="nama_peralatan_software" name="nama_peralatan_software" value="{{ old('nama_peralatan_software', $alatBantu->nama_peralatan_software) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nomor_alat') is-invalid @enderror"
                                       id="nomor_alat" name="nomor_alat" value="{{ old('nomor_alat', $alatBantu->nomor_alat) }}" required>
                                @error('nomor_alat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('tanggal_masa_kalibrasi') is-invalid @enderror"
                                       id="tanggal_masa_kalibrasi" name="tanggal_masa_kalibrasi" value="{{ old('tanggal_masa_kalibrasi', $alatBantu->tanggal_masa_kalibrasi) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('sisa_masa_kalibrasi') is-invalid @enderror"
                                       id="sisa_masa_kalibrasi" name="sisa_masa_kalibrasi" value="{{ old('sisa_masa_kalibrasi', $alatBantu->sisa_masa_kalibrasi) }}">
